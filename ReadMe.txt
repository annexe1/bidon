================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : bidon Project Overview
===============================================================================

The application wizard has created this bidon application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your bidon application.
...
res\bidon.ico
    ...
    icon is included by the main resource file bidon.rc.
...
bidonDlg.h, bidonDlg.cpp - the dialog
    These files contain your CbidonDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in bidon.rc, which can be edited in Microsoft Visual C++.
DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CbidonDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named bidon.pch and a precompiled types file named StdAfx.obj.
